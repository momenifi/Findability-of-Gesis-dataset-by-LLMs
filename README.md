...
CSV outputs generated by the pipeline use semicolon (`;`) as separator for easier opening in German/European Excel settings. The scripts can still read older comma-separated output files.
